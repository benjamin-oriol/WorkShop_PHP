...
class BookingFixtures extends Fixture implements DependentFixtureInterface {
  ...
  public function load(ObjectManager $manager)
  {
    ...
    $booking1->setEndDate(new \DateTime('2020-03-12 11:00:00'));
    $booking1->setStaff($this->getReference(AppFixtures::MONITEUR4));
    ...
    $booking->setEndDate(new \DateTime('2020-03-12 12:00:00'));
    $booking->setStaff($this->getReference(AppFixtures::MONITEUR6));
